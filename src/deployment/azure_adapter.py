# =========================================================
# ApexDeploy - Azure Deployment Adapter
...
class AzureDeploymentAdapter(BaseDeploymentAdapter):
    """Stub deployment adapter for deploying to Microsoft Azure (Container Apps). Future work."""

    def __init__(self):
        super().__init__("azure")

    async def deploy(self, context: Dict[str, Any]) -> Dict[str, Any]:
        raise NotImplementedError("Azure deployment is a future extension and is not supported in this phase.")
