# =========================================================
# ApexDeploy - AWS Deployment Adapter
...
class AWSDeploymentAdapter(BaseDeploymentAdapter):
    """Stub deployment adapter for deploying to AWS (ECS/Fargate). Future work."""

    def __init__(self):
        super().__init__("aws")

    async def deploy(self, context: Dict[str, Any]) -> Dict[str, Any]:
        raise NotImplementedError("AWS deployment is a future extension and is not supported in this phase.")
